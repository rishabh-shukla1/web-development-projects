...
// since it is a string so we cannot use . (notation)

// we cannot work on it as it is not an object

// two ways to concvert it into jason object is 1> JASON.parse()  2>JASON.stringify()


let obj=JSON.parse(jasondata);
